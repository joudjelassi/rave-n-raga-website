    ...
    <>
      ...
      <section className="relative z-10 py-24 px-6">
        ...
        >
          ...
          <p className="text-lg text-indigo-100 leading-relaxed mb-6">
            Rave N Raga is a creative collective creating intentional spaces where music, art, self-expression, and community come together.
          </p>
          <Link
            href="/about"
      ...
      <section className="relative z-10 py-24 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <Link
            href="/events"
            className="inline-block mt-14 px-6 py-2 rounded-full bg-[var(--color-accent)] text-white font-semibold hover:brightness-110 transition"
          >
            View All Events
          </Link>
        </div>
